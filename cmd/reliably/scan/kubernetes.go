...
func NewCmdScanK8s(rootCmd *cobra.Command) *cobra.Command {
	opts := &ScanOptions{
		IO:       iostreams.System(),
	...
	cmd := &cobra.Command{
		Use:   "kubernetes [path]",
		Short: "Check for Reliably Suggestions for your Kubernetes resources",
		Long: `Check your Kubernetes manifests for Reliably Suggestions.
