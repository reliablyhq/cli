...
const (
	...
	actualAvailabilityTooLowf         = "Current availability is lower than target availability by %v percent. Think about trying to increase the resources allocated of your application"
	actualAvailabilityTooHighf        = "Current availability is higher than target availability by %v percent. Think about reducing the resources allocated to your application - this could save you some money."
)
